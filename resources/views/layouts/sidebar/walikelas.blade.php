  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <ul class="nav nav-treeview bg-secondary">
            ...
            <li class="nav-item">
              <a href="{{ route('terapi.index') }}" class="nav-link">
                ...
                <p>Perkembangan Terapi (Mingguan)</p>
              </a>
            </li>
          </ul>
        </li>
        ...
        <li class="nav-item bg-info mt-2">
          <a href="{{ route('akses') }}" class="nav-link" onclick="return confirm('Beralih ke mode Guru Mapel?')">
            <i class="nav-icon fas fa-exchange-alt"></i>
            <p>
              Beralih ke Guru Mapel
            </p>
          </a>
        </li>
