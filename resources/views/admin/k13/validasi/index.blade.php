            ...
            <div class="card-body">
              ...
              <div class="callout callout-success">
                ...
                @foreach($data_kelas as $kelas)
                  @if($kelas->jumlah_anggota == 0)
                    <span class="text-danger"><i class="icon fas fa-ban"></i> Belum ditemukan <b>anggota kelas</b> pada
                      <b>{{$kelas->nama_kelas}}</b></span><br>
                  @else
                    <span class="text-success"><i class="icon fas fa-check"></i> Data kelas & wali {{$kelas->nama_kelas}}
                      valid.</span><br>
                  @endif
                @endforeach
              </div>
              <div class="callout callout-success">
                ...
                @elseif($count_siswa_invalid != 0)
                  <span class="text-danger"><i class="icon fas fa-ban"></i> Terdapat <b>{{$count_siswa_invalid}} siswa</b>
                    belum masuk anggota kelas</span><br>
                @else
              ...
              <div class="callout callout-success">
                ...
                @foreach($data_kelas as $kelas)
                  @if($kelas->jumlah_pembelajaran == 0)
                    <span class="text-danger"><i class="icon fas fa-ban"></i> Belum ditemukan <b>pembelajaran</b> pada
                      <b>{{$kelas->nama_kelas}}</b></span><br>
                  @else
                    <span class="text-success"><i class="icon fas fa-check"></i> Data pembelajaran {{$kelas->nama_kelas}}
                      valid.</span><br>
                  @endif
                @endforeach
              </div>
              <div class="callout callout-success">
                ...
                @foreach($data_ekstrakulikuler as $ekstrakulikuler)
                  @if($ekstrakulikuler->jumlah_anggota == 0)
                    <span class="text-danger"><i class="icon fas fa-ban"></i> Belum ditemukan <b>anggota ekstrakulikuler</b>
                      pada ekstrakulikuler <b>{{$ekstrakulikuler->nama_ekstrakulikuler}}</b></span><br>
                  @else
                    <span class="text-success"><i class="icon fas fa-check"></i> Data ekstrakulikuler
                      {{$ekstrakulikuler->nama_ekstrakulikuler}} valid.</span><br>
                  @endif
                @endforeach
              </div>
            </div>
            ...
            <div class="card-body">
              <div class="callout callout-success">
                ...
                @if($count_mapel_belum_mapping == 0)
                  <span class="text-success"><i class="icon fas fa-check"></i> Seluruh mata pelajaran telah dilakukan
                    mapping.</span>
                @else
                  @foreach($mapel_belum_mapping as $mapel)
                    <span class="text-danger"><i class="icon fas fa-ban"></i> Mata pelajaran <b>{{$mapel->nama_mapel}}</b>
                      belum dilakukan mapping</span><br>
                  @endforeach
                @endif
              </div>
              <div class="callout callout-success">
                ...
                @else
                  <span class="text-danger"><i class="icon fas fa-ban"></i> Terdapat {{$count_pembelajaran - $count_kkm}}
                    pembelajaran belum ditentukan KKM.</span>
                @endif
              </div>
