              ...
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title">Tambah Data Kisi-Kisi</h5>
                  ...
                  <div class="modal-body">
                    <form action="{{ route('k13kd.create') }}" method="GET">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <select class="form-control" name="tingkatan_kelas" style="width: 100%;" required
                            ...
                            <form action="{{ route('k13kd.update', $kd->id) }}" method="POST">
                              ...
                              <div class="modal-body">
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-9">
                                    <input type="text" class="form-control" id="mapel" value="{{$kd->mapel->nama_mapel}}"
                                      readonly>
                                  </div>
                                </div>
                                <div class="form-group row">
                                  <label for="kompetensi_dasar" class="col-sm-3 col-form-label">Deskripsi Kisi-Kisi</label>
                                  <div class="col-sm-9">
                                    <textarea name="kompetensi_dasar" class="form-control"
                                      rows="3">{{$kd->kompetensi_dasar}}</textarea>
                                  </div>
                                </div>
                              </div>
