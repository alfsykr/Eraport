        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div>
                <a href="{{ route('k13leger.show', $kelas->id) }}" class="btn btn-primary float-right"><i
                    class="fas fa-download"></i> Download Leger</a>
              </div>
                ...
                <table class="table table-bordered table-striped">
                  <thead class="bg-info">
                    <tr>
                      ...
                      <th class="text-center" style="width: 50px;">NIS</th>
                      <th class="text-center">Nama Siswa</th>
                      <th class="text-center" style="width: 50px;">Kelas</th>
                      <th class="text-center" style="width: 120px;">Nilai Rata-rata</th>
