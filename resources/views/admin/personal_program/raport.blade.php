    ...
    <tr>
      <td>
        <ol style="margin:0; padding-left:18px;">
          <li><strong>Motorik Kasar</strong>, {{ optional($pp)->motorik_kasar ?? '-' }}</li>
          <li><strong>Sosialisasi</strong>, {{ optional($pp)->sosialisasi ?? '-' }}</li>
          <li><strong>Rentang Akademis</strong>, {{ optional($pp)->rentang_akademis ?? '-' }}</li>
        </ol>
      </td>
      <td>
        <ol style="margin:0; padding-left:18px;">
          <li><strong>Sosialisasi</strong>, {{ optional($pp)->evaluasi_sosialisasi ?? '-' }}</li>
          <li><strong>Rentang Akademis</strong>, {{ optional($pp)->evaluasi_rentang_akademis ?? '-' }}</li>
        </ol>
      </td>
    </tr>
  </table>
  ...
  <table class="signature">
    ...
    <tr>
      <td style="padding-top:50px; text-align:left;">
        Guru
        Kelas<br><br><strong>({{ optional(optional($pp)->guru)->nama_lengkap ? ucwords(strtolower(optional(optional($pp)->guru)->nama_lengkap)) : '-' }})</strong>
      </td>
