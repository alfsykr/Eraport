...
<body>
  <table>
    <thead>
      <tr>
        <td colspan="7"><strong>LEGER NILAI SISWA</strong></td>
      </tr>
      <tr>
        <td colspan="7"><strong>{{$sekolah->nama_sekolah}}</strong></td>
      </tr>
      <tr>
        <td colspan="7">Waktu download : {{$time_download}}</td>
      </tr>
      <tr>
        <td colspan="7">Didownload oleh : {{Auth::user()->guru->nama_lengkap}} ({{Auth::user()->username}})</td>
      </tr>
    </thead>
    <tbody>
      <!-- Header -->
