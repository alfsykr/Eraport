...
class CetakRaportPTSController extends Controller
{
    ...
    public function show(Request $request, $id)
    {
        ...
        $data_id_mapel_semua = K13MappingMapel::whereIn('mapel_id', $data_id_mapel_semester_ini)->get('mapel_id');


        // Data Nilai Semua Mapel
        $data_pembelajaran_a = Pembelajaran::where('kelas_id', $anggota_kelas->kelas->id)->whereIn('mapel_id', $data_id_mapel_semua)->get();
        ...
        $data_pembelajaran_b = collect(); // Kelompok B tidak digunakan lagi
